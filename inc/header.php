...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-info-navbar-dark shadow-sm mt-4 p-2">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
                <a class="nav-link p-2 p-lg-2 mt-2 mt-lg-0 <?php if ($_GET['module']==='home') { echo 'active'; } ?>" aria-current="page" href="<?= $base_url ?>"><i class="fas fa-home"></i> Beranda</a>
            </li>
            <li class="nav-item">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle p-2 p-lg-2 mt-2 mt-lg-0" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
